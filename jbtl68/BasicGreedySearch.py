...
added_note = "If two cities have the same distance from the current one, then the first city found will be chosen"
...
while(len(tour) != num_cities):
    ...
    tour_length += fringe_distances[next_city]
